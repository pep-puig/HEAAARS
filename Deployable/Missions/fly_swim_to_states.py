...
from FSM.fsm import StateEnum, State , FSM, RobotSystem
from Handlers.handlers import PoseHandler, BatteryHandler, ParameterHandler, TimeHandler, WaterLandingHandler
...
class LandingAtTarget(State):
    ...
    def run(self, robot):
        ...
        # Unwind water sensor servo
        print("Unwinding water sensor servo")
        robot.servo_water_sensor.command_unwind()        
...
class Swim2Target(State):
    ...
    def run(self, robot):
        ...
        robot.navigator.command_aquatic_goto(target_location)
        ...
        robot.navigator.disarm(robot.aquatic)
